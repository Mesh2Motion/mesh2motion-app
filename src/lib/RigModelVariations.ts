...
export const humanVariations: ModelVariation[] = [
  ...
  createVariation(HUMAN_TYPE, { variant: 'killer_6', displayName: 'Killer 6', attribution: '', license: 'CC0', pelvisPositionScale: 1.05 }),
  createVariation(HUMAN_TYPE, { variant: 'killer_7', displayName: 'Killer 7', attribution: '', license: 'CC0'}),
